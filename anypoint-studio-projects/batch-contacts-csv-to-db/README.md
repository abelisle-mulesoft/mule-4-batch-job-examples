...
![Contacts CSV File to Database Introduction](docs/images/CSV-To-DB-01-Introduction.png)
...
![Mule configuration files](docs/images/CSV-To-DB-02-Mule-Config-Files.png)
...
![Properties file template](docs/images/CSV-To-DB-03-Properties-Files.png)
...
![env global property](docs/images/CSV-To-DB-04-Env-Global-Property.png)
...
![Configuration properties](docs/images/CSV-To-DB-05-Configuration-Properties.png)
...
![Implementation Overview](docs/images/CSV-To-DB-06-Implementation-Overview.png)
...
![Child Flow `initialization-flow`](docs/images/CSV-To-DB-07-Child-Flow-initialization-flow.png)
...
![Child Flow `send-email-report-flow`](docs/images/CSV-To-DB-08-Child-Flow-send-email-report-flow.png)
...
![Main Flow `contacts-batch-process-flow`](docs/images/CSV-To-DB-09-Main-Flow-contacts-batch-process-flow.png)
...
![Batch Job `file-processing-job`](docs/images/CSV-To-DB-10-Batch-Job-file-processing-job.png)
...
![Batch Job Settings](docs/images/CSV-To-DB-11-Batch-Job-Settings.png)
...
![Batch Step `main-processing-step` Settings](docs/images/CSV-To-DB-12-Main-Batch-Step-Settings.png)
...
![Batch Step `main-processing-step`](docs/images/CSV-To-DB-13-Main-Batch-Step.png)
...
![Main Batch Aggregator Settings`](docs/images/CSV-To-DB-14-Main-Batch-Aggregator-Settings.png)
...
![Batch Step `failed-records-processing-step` Settings](docs/images/CSV-To-DB-15-Failures-Batch-Step-Settings.png)
...
![Batch Step `failed-records-processing-step`](docs/images/CSV-To-DB-16-Failures-Batch-Step.png)
...
![Batch Job On Complete](docs/images/CSV-To-DB-17-Batch-Job-On-Complete.png)
...
- Once again, I intentionally kept my implementation simple while illustrating the art of the possible.
  ...
  ![Summary Report Example](docs/images/CSV-To-DB-18-Summary-Report-Example.png)
